...
constexpr uint8_t MOTOR_PIN_FR = 5;   // GPIO5  (Deneyap A1)
constexpr uint8_t MOTOR_PIN_RL = 6;   // GPIO6  (Deneyap A2)
constexpr uint8_t MOTOR_PIN_FL = 7;   // GPIO7  (Deneyap A3)
constexpr uint8_t MOTOR_PIN_RR = 15;  // GPIO15 (Deneyap A4)
