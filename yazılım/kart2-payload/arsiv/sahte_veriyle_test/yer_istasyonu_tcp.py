...
def main():
    ...
    print("Model yuklendi:", MODEL_YOLU, "-> siniflar:", model.names)
    if set(model.names.values()) - {"Fire", "Smoke", "fire", "smoke"}:
        print("!! UYARI: bu model fire/smoke degil gibi gorunuyor. Dogru best.pt'yi kullandigindan emin ol.")
